...
var l_itvnour=setInterval(function(){
    if(myid!=null){
        ...
        $("div#users .uzr.baht1 .My_vedio1").click(function(){
        $("#movon1").show();
        $('#movon1').addClass('baht1');
...
#users .uzr.s3ed1 {
  ...
  border: 1px solid #fff;
 background-image: url(https://up6.cc/2024/01/170622859220941.png);
background-size: 100%;
...
#users .uzr.s3ed1 .u-topic {
margin-left: 200px;
   -webkit-text-fill-color: #0000!important;

}

#users .uzr.s3ed1 .itarr_s3ed1 {
 width: 0px;
...
var l_itvnour=setInterval(function(){
    if(myid!=null){
        clearInterval(l_itvnour);
        $("#users .uzr:contains('ٓ. شــغــب')").addClass('s3ed1');
...
var l_itvaiah=setInterval(function(){
	...
	$("#users .uzr.aiah1 span.u-topic").after('<img id="mystory1" class="My_vedio1" title="ستوري" style="float: right;width: 20px;margin-top: 0px;margin-right: 5px;cursor: pointer;" src="https://i.ibb.co/47VS4nY/image.png">');
        ...
        $("#movon1").append('<iframe id="ifr_mov1" style="max-width: 340px;min-width: 300px;right: 0; top: 35px; left: auto;" class="modal in" role="dialog" style="z-index: 2100; display: none; style="max-width:240px;" src="https://www.youtube.com/embed/SJKeDG8lw04" allowfullscreen="" width="338" height="490" frameborder="0"></iframe>');
        $("#ifr_mov1").show(function(){
        $("#upro").modal("hide");
    } ); 
});
...
var l_itvshihanh=setInterval(function(){
    if(myid!=null){
        ...
        $("#users .uzr:contains('سطر')").addClass('shihanh1');
